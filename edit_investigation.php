...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update_investigation']) && $investigation) {
...
<head>
    ...
    <title>Edit Investigation - Disciplinary Branch SBHQ</title>
        ...
        <header class="main-header">
            <div class="header-content">
                <div class="d-flex align-items-center">
                    ...
                    <div class="ms-3">
                        <h1 class="page-title">Edit Investigation</h1>
                        <div class="header-subtitle">Update investigation record</div>
                    </div>
                </div>
                ...
                <div class="form-card">
                    <div class="form-header">
                        ...
                        <?php if ($investigation): ?>
                            <div class="current-file-number">
                                File Number: <?php echo $investigation['file_number']; ?>
                            </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <form method="POST" action="">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="file_number" name="file_number" 
                                       value="<?php echo htmlspecialchars($investigation['file_number']); ?>" required>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="official_number" name="official_number" 
                                       value="<?php echo htmlspecialchars($investigation['official_number']); ?>" 
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="first_name" name="first_name" 
                                       value="<?php echo htmlspecialchars($investigation['first_name']); ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="last_name" name="last_name" 
                                       value="<?php echo htmlspecialchars($investigation['last_name']); ?>" required>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="nic_number" name="nic_number" 
                                       value="<?php echo htmlspecialchars($investigation['nic_number']); ?>" 
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="police_id_number" name="police_id_number" 
                                       value="<?php echo htmlspecialchars($investigation['police_id_number']); ?>" required>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="main_branch_name" name="main_branch_name" 
                                       value="<?php echo htmlspecialchars($investigation['main_branch_name']); ?>" 
                                       required placeholder="e.g., කොළඹ දිස්ත්‍රික් මූලස්ථානය">
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="sub_branch_name" name="sub_branch_name" 
                                       value="<?php echo htmlspecialchars($investigation['sub_branch_name']); ?>" 
                                       placeholder="e.g., කොළඹ දකුණ පොලිස් ස්ථානය">
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="offense_description" name="offense_description" rows="4" 
                                      required placeholder="Enter offense description in Sinhala"><?php echo htmlspecialchars($investigation['offense_description']); ?></textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="investigating_officer" name="investigating_officer" 
                                   value="<?php echo htmlspecialchars($investigation['investigating_officer']); ?>" 
                        ...
                        <div class="alert alert-info">
                            ...
                            <strong>Last Updated:</strong> <?php echo formatDate($investigation['updated_at']); ?>
                            <br>
                            <strong>Created:</strong> <?php echo formatDate($investigation['created_at']); ?>
                        </div>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <div>
                                ...
                                <a href="view_investigation.php?id=<?php echo $investigation_id; ?>" class="btn btn-view ms-2">
