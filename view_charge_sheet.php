...
$charge_sheet_data = $stmt->fetch();

if (!$charge_sheet_data) {
    $error = 'Charge sheet not found';
} else {
    $charge_sheet = $charge_sheet_data;
}
...
<head>
    ...
    <title><?php echo $is_print ? 'Print - ' : ''; ?>Charge Sheet Details - Disciplinary Branch SBHQ</title>
        ...
        <header class="main-header no-print">
            <div class="header-content">
                <div class="d-flex align-items-center">
                    ...
                    <div class="ms-3">
                        <h1 class="page-title">Charge Sheet Details</h1>
                        <div class="header-subtitle">View complete charge sheet record</div>
                    </div>
                </div>
        ...
        <div class="content-wrapper">
            <?php if ($error): ?>
                ...
                <div class="text-center">
                    <a href="charge_sheets.php" class="btn btn-primary">
                        <i class="fas fa-arrow-left me-2"></i>Back to Charge Sheets
                    </a>
                </div>
            <?php else: ?>
                ...
                <div class="action-buttons no-print">
                    <a href="charge_sheets.php" class="btn btn-action btn-back">
                        <i class="fas fa-arrow-left"></i>
                        Back to List
                    </a>
                    <a href="?id=<?php echo $charge_sheet_id; ?>&print=1" class="btn btn-action btn-print" target="_blank">
                        <i class="fas fa-print"></i>
                        Print Report
                    </a>
                    <a href="edit_charge_sheet.php?id=<?php echo $charge_sheet_id; ?>" class="btn btn-action btn-edit">
                ...
                <div class="detail-card">
                    ...
                    <div class="info-row">
                        <div class="info-label">
                            <i class="fas fa-hashtag me-2"></i>Charge Sheet Number:
                        </div>
                        <div class="info-value sinhala highlight">
                            <strong><?php echo $charge_sheet['charge_sheet_number']; ?></strong>
                        </div>
                    </div>
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-value highlight">
                            <strong><?php echo formatDate($charge_sheet['issued_date']); ?></strong>
                        </div>
                    </div>
                    
                    <?php if (!empty($charge_sheet['disciplinary_order_number'])): ?>
                    <div class="info-row">
                        <div class="info-label">
                            <i class="fas fa-file-alt me-2"></i>Disciplinary Order Number:
                        </div>
                        <div class="info-value sinhala">
                            <span class="order-badge"><?php echo $charge_sheet['disciplinary_order_number']; ?></span>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-value">
                            <?php echo formatDate($charge_sheet['created_at']); ?>
                        </div>
                    </div>
                    
                    <?php if (!empty($charge_sheet['updated_at']) && $charge_sheet['updated_at'] != $charge_sheet['created_at']): ?>
                    <div class="info-row">
                        <div class="info-label">
                            <i class="fas fa-edit me-2"></i>Last Updated:
                        </div>
                        <div class="info-value">
                            <?php echo formatDate($charge_sheet['updated_at']); ?>
                        </div>
                    </div>
                    <?php endif; ?>
                </div>
                ...
                <?php if (!empty($charge_sheet['transfer_order_number']) || !empty($charge_sheet['suspension_order_number']) || !empty($charge_sheet['reinstate_order_number'])): ?>
                <div class="detail-card">
                    ...
                    <?php if (!empty($charge_sheet['transfer_order_number'])): ?>
                    <div class="info-row">
                        <div class="info-label">
                            <i class="fas fa-exchange-alt me-2"></i>Transfer Order:
                        </div>
                        <div class="info-value">
                            <span class="order-badge sinhala"><?php echo $charge_sheet['transfer_order_number']; ?></span>
                            <?php if (!empty($charge_sheet['transfer_date'])): ?>
                                <br><small class="text-muted">Date: <?php echo formatDate($charge_sheet['transfer_date']); ?></small>
                            <?php endif; ?>
                        </div>
                    </div>
                    <?php endif; ?>
                    
                    <?php if (!empty($charge_sheet['suspension_order_number'])): ?>
                    <div class="info-row">
                        <div class="info-label">
                            <i class="fas fa-pause me-2"></i>Suspension Order:
                        </div>
                        <div class="info-value">
                            <span class="order-badge sinhala"><?php echo $charge_sheet['suspension_order_number']; ?></span>
                            <?php if (!empty($charge_sheet['suspension_date'])): ?>
                                <br><small class="text-muted">Date: <?php echo formatDate($charge_sheet['suspension_date']); ?></small>
                            <?php endif; ?>
                        </div>
                    </div>
                    <?php endif; ?>
                    
                    <?php if (!empty($charge_sheet['reinstate_order_number'])): ?>
                    <div class="info-row">
                        <div class="info-label">
                            <i class="fas fa-play me-2"></i>Reinstatement Order:
                        </div>
                        <div class="info-value">
                            <span class="order-badge sinhala"><?php echo $charge_sheet['reinstate_order_number']; ?></span>
                            <?php if (!empty($charge_sheet['reinstate_date'])): ?>
                                <br><small class="text-muted">Date: <?php echo formatDate($charge_sheet['reinstate_date']); ?></small>
                            <?php endif; ?>
                        </div>
                    </div>
                    <?php endif; ?>
                ...
                <div class="detail-card">
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-value">
                            <?php echo $charge_sheet['police_id_number']; ?>
                        </div>
                    </div>
                ...
                <div class="detail-card">
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-value sinhala">
                            <?php echo nl2br(htmlspecialchars($charge_sheet['offense_description'])); ?>
                        </div>
                    </div>
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-value">
                            <?php echo formatDate($charge_sheet['offense_date']); ?>
                        </div>
                    </div>
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-value sinhala">
                            <?php echo $charge_sheet['investigating_officer']; ?>
                        </div>
                    </div>
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-value sinhala">
                            <?php echo $charge_sheet['action_name']; ?>
                        </div>
                    </div>
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-value">
                            <span class="status-badge <?php 
                                echo $charge_sheet['pi_status'] == 'විමර්ෂණයේ පවතී' ? 'status-active' : 
                                    ($charge_sheet['pi_status'] == 'අවසන් කර ඇත' ? 'status-completed' : 'status-transferred'); 
                            ?>">
                                <?php 
                                $status_map = [
                                ...
                                echo $status_map[$charge_sheet['pi_status']] ?? $charge_sheet['pi_status'];
                                ?>
                            </span>
                        </div>
                    </div>
